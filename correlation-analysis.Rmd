---
title: "Correlation analysis with human data"
output: pdf_document
date: "2025-07-09"
---
...
```{r human_data_by_group, echo=FALSE}
...
```{r}
# Pipeline to generate Figure 3 modified to generate Figure 6
...
```{r}
# Pipeline to generate and Best Prompt for Each Model Figure 7 and Table 7
model_files <- c(
